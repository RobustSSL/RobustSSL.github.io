    ...
    scheduleData.forEach((item, index) => {
        ...
        // if (!!item.comment) {
        //     col2.innerHTML = `<h5><center><a style="color: #000000" href=${item.link}>${item.paper}</a> <br> <small><sup>*</sup>${item.comment}</small>  </center></h5>`;
        //     col2.style.color = '#000000'
        // }else {
        //     col2.innerHTML = `<h5><center><a style="color: #000000" href=${item.link}>${item.paper}</a> </center></h5>`;
        // }
        col2.classList.add('col');
        if (!!item.comment) {
