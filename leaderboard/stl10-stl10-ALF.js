    ...
    const scheduleData_stl10_stl10_ALF = [
        ...
        comment: '', ra1: 48.89, ca1: 0, sa1: 71.60, ra2:47.56, ca2: 0, sa2: 71.62},
        { paper: 'Enhancing Adversarial Contrastive Learning via Adversarial Invariant Regularization', link: 'https://arxiv.org/abs/2305.00374', venue: 'NeurIPS 2023', 
        comment: 'Using post-processing', ra1: 48.59, ca1: 0, sa1: 71.45, ra2:48.4, ca2:0 , sa2:69.51},
        ...
        comment: 'Using post-processing', ra1: 48.06, ca1: 0, sa1: 69.51, ra2: 47.21, ca2: 0, sa2: 70.38},
        { paper: 'Rethinking the Effect of Data Augmentation in Adversarial Contrastive Learning ', link: 'https://openreview.net/forum?id=0qmwFNJyxCL&noteId=ZXhFXELOcQ', venue: 'ICLR 2023', 
        comment: '', ra1: 47.69, ca1: 0, sa1: 67.65, ra2: 46.83, ca2:0, sa2:69.79},
        ...
        comment: '', ra1: 43.79, ca1: 0, sa1: 67.81, ra2: 37.92	, ca2: 72.65, sa2: 	80.65},
        ...
        comment: '', ra1: 38.10, ca1: 0, sa1: 69.96, ra2: 33.32, ca2: 0, sa2: 69.66},
    ];						

    // Get the container element by its id
    const scheduleContainer_stl10_stl10_ALF = document.getElementById('scheduleContainer_stl10_stl10_ALF');

    // Loop through the data and create schedule items
    scheduleData_stl10_stl10_ALF.forEach((item, index) => {
        ...
        scheduleContainer_stl10_stl10_ALF.appendChild(scheduleItem);
    });
